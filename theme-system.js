...
const themes = {
  neon: {
    ...
    colors: {
      ...
      '--navcode-gradient-primary': 'linear-gradient(135deg, #00d4ff 0%, #0099cc 50%, #a55eea 100%)',
      '--navcode-gradient-secondary': 'linear-gradient(135deg, #ff6b6b 0%, #ffa726 50%, #00ff88 100%)',
      '--navcode-gradient-dark': 'linear-gradient(135deg, #0a0a0a 0%, #1a1a1a 50%, #2d2d2d 100%)',
      '--navcode-gradient-glass': 'linear-gradient(135deg, rgba(255, 255, 255, 0.1) 0%, rgba(255, 255, 255, 0.05) 100%)',
      '--navcode-gradient-rainbow': 'linear-gradient(45deg, #00d4ff, #ff6b6b, #a55eea, #00ff88, #ffa726)',
  ...
  light: {
    ...
    colors: {
      ...
      '--navcode-gradient-primary': 'linear-gradient(135deg, #2563eb 0%, #1d4ed8 100%)',
      '--navcode-gradient-secondary': 'linear-gradient(135deg, #dc2626 0%, #b91c1c 100%)',
      '--navcode-gradient-dark': 'linear-gradient(135deg, #ffffff 0%, #f9fafb 100%)',
      '--navcode-gradient-glass': 'linear-gradient(135deg, rgba(255, 255, 255, 0.8) 0%, rgba(249, 250, 251, 0.9) 100%)',
      '--navcode-gradient-rainbow': 'linear-gradient(45deg, #2563eb, #dc2626, #7c3aed, #059669, #d97706)',
  ...
  dark: {
    ...
    colors: {
      ...
      // Gradientes Escuros
      '--navcode-gradient-primary': 'linear-gradient(135deg, #60a5fa 0%, #3b82f6 100%)',
      '--navcode-gradient-secondary': 'linear-gradient(135deg, #f87171 0%, #ef4444 100%)',
      '--navcode-gradient-dark': 'linear-gradient(135deg, #111827 0%, #1f2937 50%, #374151 100%)',
      '--navcode-gradient-glass': 'linear-gradient(135deg, rgba(31, 41, 55, 0.8) 0%, rgba(17, 24, 39, 0.9) 100%)',
      '--navcode-gradient-rainbow': 'linear-gradient(45deg, #60a5fa, #f87171, #a78bfa, #34d399, #fbbf24)',
